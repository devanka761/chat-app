...
import { ICookieUserB } from "../../interfaces/binder.interfaces"
...
router.post("/verify", (req: Request, res: Response) => {
  ...
  const userData = verifyUser.data.user as ICookieUserB
...
router.get("/:provider/callback", async (req: Request, res: Response) => {
  ...
  const userData = verifyUser.data as ICookieUserB
  req.user = {
    id: userData.id,
    data: {
      id: userData.data.id,
