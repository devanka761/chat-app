import { SivalKeyType, ValidateArr, ValidateObj } from "../types/validate.types"

export default function validate(snap: ValidateArr | ValidateObj, data?: SivalKeyType): boolean {
