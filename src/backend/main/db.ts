import fs from "fs"
import { DatabasesB, IUserB } from "../../interfaces/dbserver.interfaces"
...
class DevankaLocal {
  ...
  load(): void {
    ...
    Object.keys(this.ref)
      ...
      .forEach((file) => {
        const fileKey = file as keyof DatabasesB
  ...
  save(...args: string[]): void {
    ...
    for (const arg of args) {
      const s = arg as keyof DatabasesB
